...
import (
	...
	"github.com/minhvu2510/golang-gin/service/article_service"
...
func GetArticle(c *gin.Context) {
	appG := app.Gin{C: c}
	id := com.StrTo(c.Param("id")).MustInt() // str to int
	valid := validation.Validation{}         // khoi tao vadiation
	valid.Min(id, 1, "id")
	if valid.HasErrors() {
...
func DeleteArticle(c *gin.Context) {
	...
	valid.Min(id, 1, "id").Message("IDlonhon0")
